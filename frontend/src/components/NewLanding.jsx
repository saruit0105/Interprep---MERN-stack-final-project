...
//         typewriter.typeString('Do you want to learn how to code?')
//             .pauseFor(2500)
//             .deleteChars(12)
//             .typeString('React')
//             .pauseFor(2500)
...
//             <h1 id="app"></h1>
//             <br></br>
//             Here at BananaFish we are dedicated to helping our users get a career in tech
//             that being said, I need a career in tech
...
//     <article>
//       <h1>Maincode</h1>
//       <p>Welcome to #Maincode! You're web-dev? A web-designer? From around Frankfurt? Awesome, you found the right spot to make your dreams come true.</p>
...
//       <p>Just drop a line to <a href="mailto:#">sponsor@maincode.io</a>.</p>
//     </article>
//   </section>
// </div>
